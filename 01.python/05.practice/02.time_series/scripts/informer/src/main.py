...
class Informer(nn.Module):
    def __init__(self, task_name, seq_len, pred_len, label_len, enc_in, dec_in, d_model, dropout, factor, output_attention,
                 n_heads, d_ff, e_layers, d_layers, distil, c_out, embed='fixed', freq='h'):
